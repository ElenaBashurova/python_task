...
def function_for_text(func_text, *args):
    name_f = func_text.__name__.title().replace("_", " ")
    parameter = ", ".join([*args])
    print(f"{name_f} [{parameter}]")
    return f"{name_f} [{parameter}]"
...
def open_browser(browser_name):
    actual_result = function_for_text(open_browser, browser_name)
    assert actual_result == "Open Browser [Chrome]"


def go_to_companyname_homepage(page_url):
    actual_result = function_for_text(go_to_companyname_homepage, page_url)
    assert actual_result == "Go To Companyname Homepage [https://companyname.com]"


def find_registration_button_on_login_page(page_url, button_text):
    actual_result = function_for_text(
